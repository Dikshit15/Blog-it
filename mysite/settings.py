...
SECRET_KEY = '2!i9v(o(ddf75_70zm&2pv4=x@ybl!%&j2-@ez^ue^$=%(d)*2'
...
#There are a lot of different datatbases that can store data for our website.
#We will use the default one i.e. sqlite3.
DATABASES = {
    'default': {
